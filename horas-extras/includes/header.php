...
<nav class="navbar navbar-expand-lg navbar-dark viprint-navbar no-print">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?= BASE_URL ?>/index.php">ViPrint · Horas Extras</a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="<?= BASE_URL ?>/registros.php">Registros</a>
                <a class="nav-link" href="<?= BASE_URL ?>/formulario.php">Nuevo registro</a>
            </div>
        </div>
    </div>
</nav>
