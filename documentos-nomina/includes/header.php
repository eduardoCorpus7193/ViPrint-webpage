...
<nav class="navbar navbar-expand-lg navbar-dark viprint-navbar no-print">
    <div class="container">
        <a class="navbar-brand fw-bold" href="<?= BASE_URL ?>/index.php">ViPrint · Documentos de Nómina</a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link" href="<?= BASE_URL ?>/documentos.php">Historial</a>
                <a class="nav-link" href="<?= BASE_URL ?>/documento_form.php">Nuevo documento</a>
            </div>
        </div>
    </div>
</nav>
