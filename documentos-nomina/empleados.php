...
$employees = $pdo->query(
    'SELECT e.*,
            (SELECT COUNT(*) FROM documentos_nomina d WHERE d.empleado_id = e.id) AS documentos
     FROM empleados e
...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        ...
        <p class="text-secondary mb-0">Guarda los nombres que aparecerán en el combo de los documentos.</p>
    </div>
    <a href="<?= BASE_URL ?>/documento_form.php" class="btn btn-viprint">Nuevo documento</a>
</div>
