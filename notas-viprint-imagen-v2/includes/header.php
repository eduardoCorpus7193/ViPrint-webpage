...
<nav class="navbar navbar-expand-lg navbar-dark vip-navbar sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand d-flex align-items-center gap-2" href="<?= url('index.php') ?>">
      <span class="brand-mark">V</span><span>Notas V2</span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navMain">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <?php if (role_in(['admin','direccion','asesor'])): ?><li class="nav-item"><a class="nav-link" href="<?= url('usuarios.php') ?>">Usuarios</a></li><?php endif; ?>
      </ul>
