...
FROM v2_empresas e
JOIN (
    SELECT 'bandera' tipo, 'Bandera grande', 'Bandera grande con estructura de acero. Precio base por unidad.', 1700.00 precio UNION ALL
    SELECT 'bandera', 'Bandera mediana', 'Bandera mediana con estructura de acero. Precio base por unidad.', 1500.00 UNION ALL
    SELECT 'bandera', 'Bandera jumbo', 'Bandera jumbo con estructura de acero. Precio base por unidad.', 1900.00 UNION ALL
    SELECT 'bandera', 'Tela de bandera sin estructura', 'Tela por bandera sin estructura de acero.', 1000.00 UNION ALL
    SELECT 'lona', 'Lona', 'Lona publicitaria. Capturar medida, material y acabado.', 0.00 UNION ALL
    SELECT 'articulo', 'Artículo libre', 'Artículo manual para productos no precargados.', 0.00
) x
