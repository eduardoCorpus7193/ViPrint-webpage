...
$stmt = db()->prepare("SELECT n.*, e.nombre empresa, u.nombre disenador FROM v2_notas n JOIN v2_empresas e ON e.id=n.empresa_id LEFT JOIN v2_usuarios u ON u.id=n.disenador_id WHERE $where ORDER BY n.fecha_nota DESC, n.id DESC LIMIT 12");
$stmt->execute($params); $notas=$stmt->fetchAll();
?>
<div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
  <div><h1 class="h3 mb-0">Panel de notas</h1><div class="text-muted">ViPrint e Imagen en un solo sistema, con reportes separados.</div></div>
...
<div class="card"><div class="card-header">Notas recientes</div><div class="card-body p-0"><div class="table-responsive"><table class="table table-hover mb-0"><thead><tr><th>Empresa</th><th>Folio</th><th>Cliente</th><th>Diseñador</th><th>Total</th><th>Saldo</th><th>Diseño</th><th>Producción</th><th></th></tr></thead><tbody>
